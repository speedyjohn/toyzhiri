...
ALTER TABLE bookings ADD COLUMN client_confirmed     BOOLEAN   NOT NULL DEFAULT false;
ALTER TABLE bookings ADD COLUMN partner_confirmed    BOOLEAN   NOT NULL DEFAULT false;
ALTER TABLE bookings ADD COLUMN client_confirmed_at  TIMESTAMP;
ALTER TABLE bookings ADD COLUMN partner_confirmed_at TIMESTAMP;
